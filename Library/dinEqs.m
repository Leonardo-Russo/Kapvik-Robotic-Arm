...
% This function computes the dynamic equations, giving in output the matrix
% M, the vector V, the vector G, the vector F (all this element are
% symbolic)

format long
syms q1 q2 q3 q4 q1d q2d q3d q4d q1dd q2dd q3dd q4dd g Tc real
...
TAU=collect(simplify(tau),[q1dd q2dd q3dd q4dd g]);
...
for i=1:4
    ...
    vi=coeffs(TAU(i), [q1dd q2dd q3dd q4dd g]);
    if isempty(vi)
        V(i,1)=0;
    else
        V(i,1)=vi(1);
