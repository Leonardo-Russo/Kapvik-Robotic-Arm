...
% hold on
% plot(tc,rad2deg(thetad(1,:))+1,'--r',lineWidth=1.5)
% plot(tc,rad2deg(thetad(1,:))-1,'--r',lineWidth=1.5)
xlabel('$$t$$ [s]','Interpreter','latex')
...
% hold on
% plot(tc,rad2deg(thetad(2,:))+1,'--r',lineWidth=1.5)
% plot(tc,rad2deg(thetad(2,:))-1,'--r',lineWidth=1.5)
xlabel('$$t$$ [s]','Interpreter','latex')
...
% hold on
% plot(tc,rad2deg(thetad(3,:))+1,'--r',lineWidth=1.5)
% plot(tc,rad2deg(thetad(3,:))-1,'--r',lineWidth=1.5)
xlabel('$$t$$ [s]','Interpreter','latex')
...
% hold on
% plot(tc,rad2deg(thetad(4,:))+1,'--r',lineWidth=1.5)
% plot(tc,rad2deg(thetad(4,:))-1,'--r',lineWidth=1.5)
xlabel('$$t$$ [s]','Interpreter','latex')
...
% hold on
% plot(tc,rad2deg(thetadd(1,:))+1,'--r',lineWidth=1.5)
% plot(tc,rad2deg(thetadd(1,:))-1,'--r',lineWidth=1.5)
xlabel('$$t$$ [s]','Interpreter','latex')
...
% hold on
% plot(tc,rad2deg(thetadd(2,:))+1,'--r',lineWidth=1.5)
% plot(tc,rad2deg(thetadd(2,:))-1,'--r',lineWidth=1.5)
xlabel('$$t$$ [s]','Interpreter','latex')
...
% hold on
% plot(tc,rad2deg(thetadd(3,:))+1,'--r',lineWidth=1.5)
% plot(tc,rad2deg(thetadd(3,:))-1,'--r',lineWidth=1.5)
xlabel('$$t$$ [s]','Interpreter','latex')
...
% hold on
% plot(tc,rad2deg(thetadd(4,:))+1,'--r',lineWidth=1.5)
% plot(tc,rad2deg(thetadd(4,:))-1,'--r',lineWidth=1.5)
xlabel('$$t$$ [s]','Interpreter','latex')
