...
quiver3(r(1), r(2), r(3), F(1, 2), F(2, 2), F(3, 2), "Color", color, 'LineWidth', linewidth, 'MaxHeadSize', arrowhead)
quiver3(r(1), r(2), r(3), F(1, 3), F(2, 3), F(3, 3), "Color", color, 'LineWidth', linewidth, 'MaxHeadSize', arrowhead)
